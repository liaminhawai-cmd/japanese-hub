...
window.PHRASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { ja: "東口　西口　南口　北口", en: "East, west, south, north exit",
      ...
      { ja: "税込　　税抜", en: "Tax included　　Tax not included",
